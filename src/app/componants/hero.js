            ...
            <div className="w-full md:w-1/2 md:px-3">
              <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                ...
                <p className="mx-auto text-base font-sans font-extrabold text-black sm:max-w-md lg:text-xl md:max-w-3xl">
                  ...
                  meme-worthy memecoin in the galaxy. We allowed everyone to
                  shoot their shot, but now its time for Gonzo to show the world
                  who is the greatest meme coin that ever existed!
                </p>
